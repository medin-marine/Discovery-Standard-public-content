...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="1.2">
  ...
  <sch:p>
    This Schematron schema is based on MEDIN_Schema_Documentation3_1_full.pdf. The text describing
  ...
  <sch:pattern fpi="MedinCoupledResource">
    ...
    <sch:rule context="/*">
      <sch:assert test="((contains(gmd:hierarchyLevel/*/@codeListValue, 'service')) and (contains(/*/gmd:identificationInfo/*/srv:serviceType/*, 'view') or contains(/*/gmd:identificationInfo/*/srv:serviceType/*, 'download')) and 
        ...
        If the Resource Type is service, at least one srv:operatesOn must be provided.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern fpi="MedinKeywords">
    ...
    <sch:rule context="/*/gmd:identificationInfo">
      ...
      <sch:assert test="(contains(../gmd:hierarchyLevel/*/@codeListValue, 'dataset') or 
        ...
        count(*/gmd:descriptiveKeywords/*/gmd:keyword[contains(*/@xlink:href, 'http://inspire.ec.europa.eu/metadata-codelist/SpatialDataServiceCategory/infoMapAccessService')]) &gt;= 1)">
        INSPIRE: Part D 4 of the Metadata Implementing Rules - For a service at least one keyword must come from http://inspire.ec.europa.eu/metadata-codelist/SpatialDataServiceCategory/infoMapAccessService
      </sch:assert>
  ...
  <sch:pattern fpi="MedinLimitationsOnPublicAccess">
    ...
    <sch:rule context="/*/gmd:identificationInfo/*/gmd:resourceConstraints">
      ...
      <sch:assert test="(count(*/gmd:accessConstraints) &gt;=1 and count(*/gmd:otherConstraints[contains(*/@xlink:href,'LimitationsOnPublicAccess')]) &gt;= 1) or count(*/gmd:accessConstraints) = 0">
  ...
  <sch:pattern fpi="MedinConformity">
    ...
    <sch:rule context="/*">
      <sch:assert test="count(/*/gmd:dataQualityInfo/*/gmd:report/*/gmd:result) &gt;= 1">
  ...
  <sch:pattern fpi="MedinSpecification">
    ...
    <sch:rule context="/*/gmd:dataQualityInfo/*/gmd:report/*/gmd:result/*/gmd:pass">
      <sch:assert test="gco:Boolean = 'true' or gco:Boolean = 'false'">
        Data Quality: report: result: pass: must be true or false.
      </sch:assert>
    </sch:rule>
    <sch:rule context="/*/gmd:dataQualityInfo/*/gmd:report/*/gmd:result/*">
      <sch:assert test="count(gmd:explanation) &gt; 0">
  ...
  <sch:pattern fpi="MEDIN-confResult">
    <sch:rule context="//gmd:MD_Metadata[1]">
      <sch:assert
        ...
        > Conformity: There must be at least one gmd:DQ_ConformanceResult </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern fpi="MEDIN-inspire1089">
    <sch:rule
      ...
      <sch:assert test="$localPassPath/gco:Boolean">
